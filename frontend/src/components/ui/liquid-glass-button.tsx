  ...
  return (
    <>
      <Comp
        ...
        {...props}
      >
        <div className="absolute top-0 left-0 z-0 h-full w-full rounded-[inherit] shadow-[0_4px_12px_rgba(255,255,255,0.1),inset_0_1px_1px_rgba(255,255,255,0.4)] transition-all dark:shadow-[0_4px_12px_rgba(255,255,255,0.1),inset_0_1px_1px_rgba(255,255,255,0.2)]" />
        <div
